...
- Name: wheel.spec.ts >> Wheel screen >> task card has working checkbox
- Location: tests/e2e/wheel.spec.ts:63:3
...
- generic [ref=e2]:
  ...
  - contentinfo [ref=e6]:
    - generic [ref=e7]:
      ...
      - paragraph [ref=e9]: iad1::1784478808-lM2Y3pS8sV2ZiucWP9UCl0rt4cTHlrxH
```
