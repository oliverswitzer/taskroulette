...
- Name: wheel.spec.ts >> Wheel screen >> spin button triggers spin and disables during spin
- Location: tests/e2e/wheel.spec.ts:43:3
...
- generic [ref=e2]:
  ...
  - contentinfo [ref=e6]:
    - generic [ref=e7]:
      ...
      - paragraph [ref=e9]: iad1::1784478712-veJ6X5EgpXHof4nIqEYUpczIXKWXLWTo
```
